...
class Camera(model_wrapper.ModelWrapper):
    ...
    def __init__(self,
        ...
        """ Camera model class is used to define the camera in the workspace.  """
        ...
        """ ros2_bridge is used to run the specfic model specificed by different tasks.
        Threading is used to run different model that is program will have two things happening at once. """
            ...
            if ros2_bridge_color:
                thread = Thread(target=self.construct_ros2_bridge,
                                args=(self.color_topic(),
                                      ...
                                      'ignition.msgs.Image'),
                                daemon=True) # used to construct the model.
