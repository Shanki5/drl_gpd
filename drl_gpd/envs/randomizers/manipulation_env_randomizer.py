...
"""Different task - Reach,Grasp,ReachOctree,GraspOctree are imported from the tasks folder."""
...
class ManipulationGazeboEnvRandomizer(gazebo_env_randomizer.GazeboEnvRandomizer,
    ...
    gazebo_env_randomizer.GazeboEnvRandomizer : Base class to implement an environment randomizer for Ignition Gazebo.
    physics_randomizer : Object that randomizes physics.
    Taskrandmizer : Randomize a Task instance.
    """
